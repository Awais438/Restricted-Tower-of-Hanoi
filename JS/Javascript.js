...
function buildStacks() {
	// if (obj == false) {
	// 	var html = '<div id="winbox2">' +
	// 	  '<p id="wintext">A new journey begins</p>' +
	// 	  '<p class="wintextunter">The objective of the Tower of Hanoi game is to move all the disks from the leftmost tower to the rightmost tower.</p>' +
	// 	  '<p class="wintextunter">Remember the following rules:</p>' +
	// 	  '<ul>' +
	// 	  '  <li>Only one disk can be moved at a time.</li>' +
	// 	  '  <li>A larger disk cannot be placed on top of a smaller disk.</li>' +
	// 	  '</ul>' +
	// 	  '<input class="selectbuttons" onclick="reset()" type="button" value="OK"/>' +
	// 	  '</div>';
